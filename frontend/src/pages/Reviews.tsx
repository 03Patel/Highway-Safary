...
export default function Reviews() {
  ...
  const reviews = [{ name: "Rahul Sharma", image: "https://i.pravatar.cc/150?img=1", rating: 5, text: "The trip was perfectly organized and the destinations were breathtaking. I loved every moment of the journey!", },
    ...
    <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-blue-50 via-white to-orange-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <Swiper
          ...
          breakpoints={{
            0: { slidesPerView: 1 },   // 👈 slight peek effect
            640: { slidesPerView: 1 },
            768: { slidesPerView: 2 },
        ...
        >
          ...
          {reviews.map((review, index) => (
            <SwiperSlide key={index}>
              <div className="bg-white/90 backdrop-blur-lg border border-gray-200 p-5 sm:p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-500 h-full flex flex-col justify-between">
